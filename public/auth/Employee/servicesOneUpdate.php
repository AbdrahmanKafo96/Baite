...
<div class="wrapper">
    ...
    <div id="ads-form" class="main p-3 me-3">
        <div>
            <h1 class="text-right m-3">تعديل خدمة فرعية</h1>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        console.log(`id: ${id}, Name of service: ${serviceName}, Desciption: ${serviceDescription}, Status: ${show}, Service ID: ${serviceID}`);
